...
//                         height: size,
//                         decoration:
//                             BoxDecoration(shape: BoxShape.circle, image: DecorationImage(image: Image.asset("assets/images/radial_scale.png").image)),
//                       ),
//                     ),
//                     Center(
//                       child: Container(
                  ...
                  children: [
                    ShaderMask(
                      ...
                      child: Container(
                        ...
                        height: size,
                        decoration:
                            BoxDecoration(shape: BoxShape.circle, image: DecorationImage(image: Image.asset("assets/radial_scale.png").image)),
                      ),
                    ),
                    Center(
                      child: Container(
